...
\date{13th November 2020} % Date, can be changed to a custom date
\begin{columns}
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      $$ \frac{\partial C_{i}}{\partial t} + u_{r} \frac{\partial C_{i}}{\partial r} = \frac{D_{i}}{r^{2}} \frac{\partial}{\partial r} \left( r^{2} \frac{\partial C_{i}}{\partial r}\right)$$
