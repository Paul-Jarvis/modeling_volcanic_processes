...
\title[Modeling volcanic processes]{Introduction to modeling \\ Magma generation and properties} % The short title appears at the bottom of every slide, the full title is only on the title page
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{minipage}[t][.6\textheight][t]{\linewidth}
            ...
            \begin{itemize}
            \item Conceptual model - Composition of ideas to aid knowledge and understanding \\
            \end{itemize}
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{minipage}[t][.6\textheight][t]{\linewidth}
        ...
        $$\includegraphics[width=0.6\textwidth]{Cashman17.png}$$
...
\begin{frame}
  ...
  $$\includegraphics[width=\textwidth]{annotatedCurrent.png}$$
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{minipage}[t][.6\textheight][t]{\linewidth}
        ...
        $$\includegraphics[width=\textwidth]{Suzuki16.png}$$
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{minipage}[t][.6\textheight][t]{\linewidth}
        ...
        $$\includegraphics[width=\textwidth]{Mastin09.png}$$

        \vspace{-0.2cm}
      
        \centering \tiny Mastin et al. (2009)
...
\begin{frame}
  ...
  $X_{i}$ can be expressed in mol\% or wt\% \\
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      Thermodynamics $\implies$ 3 ways to melt rocks:

      \begin{itemize}
      \item Increase temperature \\
      \item Decrease pressure \\
      \item Change composition \\
      \end{itemize}

      \vspace{0.5cm}
      
      Can \textbf{model} these assuming \textbf{Chemical equilibrium} - System has sufficient time to respond to changes in:
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \item \textbf{Depressurisation}: Reduce $P$ \\
        \begin{itemize}
        \item \textbf{Adiabatic} process - No transfer of heat $Q$ or mass between system and surroundings \\
        \item \textbf{Adiabatic decompression} - Magma rises faster than it can transfer heat to its surroundings \\
        \end{itemize}
      \end{itemize}

      For reversible processes, can define entropy $S$ as:

      $$ \mathrm{d}S = \frac{\mathrm{d}Q}{T} $$

      Thus, adiabatic process is also \textbf{isentropic} ($\mathrm{d}S = 0$) \\
    \end{column}
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{itemize}
      \item Magma properties controlled by $P$, $T$ and $\mathbf{X}$ \\
      \item \textbf{Models} - Representations of reality \\
      \item Models can describe:
        \begin{itemize}
        \item Processes, e.g., magma generation by:
          \begin{itemize}
          \item Heating \\
          \item Decompression \\
          \item Mixing \\
    ...
    \begin{column}{0.5\paperwidth}
      ...
      $$\includegraphics[width=0.8\textwidth]{Holtz05.png}$$

      \vspace{-0.3cm}

      \centering \tiny Holtz et al. (2005) \\
