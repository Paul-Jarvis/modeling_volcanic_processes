...
%-----------------------------------------------
\begin{frame}
  \frametitle{Fundamental fluid dynamics: Streamlines}

  \textbf{Streamlines} - Curves which are instantaneously tangent to the velocity field
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\paperwidth}
      ...
      $$\includegraphics[width=0.5\textwidth, angle=180]{laminar.png}$$
...
\begin{frame}
  ...
  \begin{align*}
    F = W \bigg( & \int_{0}^{h} (P_{\text{C}} - g \rho_{\text{e}} z - P_{\text{B}} + g \rho_{\text{c}} z) \mathrm{d} z  \\
    & + \int_{h}^{H} [P_{\text{C}} - g \rho_{\text{e}} z - P_{\text{B}} + g \rho_{\text{c}} h + g \rho_{\text{e}} (z - h)] \mathrm{d} z \bigg)
    \end{align*}

  \begin{align*}
    F = W \bigg( & (P_{\text{C}} - P_{\text{B}}) h + \frac{g (\rho_{\text{c}} - \rho_{\text{e}}) h^{2}}{2}  \\
    & + [P_{\text{C}} - P_{\text{B}} + g (\rho_{\text{c}} -\rho_{\text{e}}) h] (H - h) \bigg)
    \end{align*}
\end{frame}
%-----------------------------------------------
\begin{frame}
  ...
  $$ F = W \left[ (P_{\text{C}} - P_{\text{B}}) H + g (\rho_{\text{c}} - \rho_{\text{e}}) h \left( H - \frac{h}{2}\right)\right]$$

  $$ W \left[ (P_{\text{C}} - P_{\text{B}}) H + g (\rho_{\text{c}} - \rho_{\text{e}}) h \left( H - \frac{h}{2}\right)\right] = [U^{2} H - u_{1}^{2} (H - h)] \rho_{\text{e}} W $$
\end{frame}
%-----------------------------------------------
\begin{frame}
